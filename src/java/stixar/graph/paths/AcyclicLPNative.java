 ...
 */
public class AcyclicLPNative extends AcyclicLPBase // in AcyclicLP.java
{
    protected NativeNodeMap distMap;
    protected NativeEdgeMap weights;
    
    public AcyclicLPNative(Digraph dg, 
                           Node source, 
                           Node target, 
        ...
        case Float:
            ...
            for (Node n : digraph.nodes()) {
                if (n == source)
                    ...
                    fmap.set(n, Float.NEGATIVE_INFINITY);
            }
            break;
        ...
        case Double:
            ...
            for (Node n : digraph.nodes()) {
                if (n == source)
                    ...
                    dmap.set(n, Double.NEGATIVE_INFINITY);
            }
            break;
        default:
