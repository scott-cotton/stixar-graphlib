...
/**
   Marker Interface for a set of node attributes stored
   ...
   unboxing numbers all the time.  Where speed is important, NativeNodeMaps are 
   the preferred attribute mechanism for numeric attributes.
   </p>
 ...
 */
public interface NativeNodeMap extends NativeMap, NodeData
{}