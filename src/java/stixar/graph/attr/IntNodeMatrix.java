 ...
 */
public class IntNodeMatrix implements NativeNodeMatrix
{
    protected int[][] data;
    
    public IntNodeMatrix(int[][] data)
    {
        this.data = data;
    }
    ...
    public int set(Node u, Node v, int val)
    {
    ...
    public void grow(int cap)
    {
        ...
        int[][] newData = new int[cap][cap];
        int i=0;
        for(int[] a : data) {
            int[] newA = new int[cap];
